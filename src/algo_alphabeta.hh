...
public:
    ...
    void registerTTable(ttable_ptr tt)
    {
        m_ttable = tt;
    }
    ...
    void registerExperience(experience_ptr e)
    {
        m_experience = e;
    }
    ...
    void setMaxTime_msec(int msecs)
    {
        m_maxMSecs = msecs;
    }
    ...
    int askMaxTime_msec() const
    {
        return m_maxMSecs;
    }
    int askMaxDepth() const
    {
        return m_maxDepth;
    }
    ...
    void setEvalWeight(Weight w, float val)
    {
        m_weight[w] = val;
    }
    float askEvalWeight(Weight w) const
    {
        return m_weight[w];
    }
