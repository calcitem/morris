...
public:
    ...
    boardspec_ptr getBoardSpec() const
    {
        return m_ruleSpec->boardSpec;
    }
    rulespec_ptr getRuleSpec() const
    {
        return m_ruleSpec;
    }
    ...
    */
    ...
    void forceMove()
    {
        m_player[player2Index(m_board->getCurrentPlayer())]->forceMove();
    }
    ...
    {
        return getCurrentBoard().getCurrentPlayer();
    }
    player_ptr getCurrentPlayerInterface() const
    {
        return m_player[player2Index(m_board->getCurrentPlayer())];
    }
    ...
    {
        return m_currentHistoryPos;
    }
    int getHistorySize() const
    {
        return m_history.size();
    }
    Move getHistoryMove(int ply) const
    {
        return m_movelog[ply];
    }
    boost::shared_ptr<Board> getHistoryBoard(int ply) const
    {
        return m_history[ply];
    }

    // --- signals ---

    boost::signals2::signal<void(Player)> &getSignal_gameOver()
    {
        return m_signal_gameOver;
    }
    boost::signals2::signal<void(GameState)> &getSignal_changeState()
    {
        return m_signal_changeState;
    }
    boost::signals2::signal<void()> &getSignal_changeBoard()
    {
        return m_signal_changeBoard;
    }
    boost::signals2::signal<void(player_ptr)> &getSignal_startMove()
    {
        return m_signal_startMove;
    }
    boost::signals2::signal<void(player_ptr)> &getSignal_endMove()
    {
        return m_signal_endMove;
    }
