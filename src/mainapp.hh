...
public:
    ...
    */
    ...
    void registerConfigManager(configmanager_ptr p)
    {
        m_configManager = p;
    }
    configmanager_ptr getConfigManager()
    {
    ...
    player_ptr &getAIPlayer(int p)
    {
        return player_computer[p];
    }
    ttable_ptr &getTTable(int p)
    {
        return ttable[p];
    }
    bool getShareTTables()
    {
        return share_TT;
    }
    ...
    void setApplicationGUI(appgui_ptr gui)
    {
        gui_application = gui;
    }
    appgui_ptr getApplicationGUI() const
    {
    ...
    {
        return gui_application->getBoardGUI();
    }
    ...
    boost::signals2::signal<void(bool)> &getSignal_pauseChanged()
    {
        return m_signal_pauseChanged;
    }
